...
$cmdBuild = "Set-Location -LiteralPath '$repoRootEscaped'; npm run build:prompts; npm run build:main; npm run build:preload; `$env:NODE_ENV='development'; npx electron ."
