...
export function generateTabExportHtml(
	...
	// Guru app icon as base64 PNG (72x72) - same as groupChatExport
...
<head>
  ...
  <title>${escapeHtml(tabName)} - Guru Tab Export</title>
  <style>
    :root {
  ...
  <div class="container">
    ...
    <div class="branding">
      <div class="branding-logo">
        <img src="${maestroIconBase64}" alt="Guru" />
      </div>
      <div class="branding-text">
        ...
        <div class="branding-links">
          ...
          <a href="https://github.com/RunMaestro/Guru" target="_blank" class="branding-link">
    ...
    <footer class="footer">
      <p>Exported from <a href="https://runmaestro.ai" target="_blank">Guru</a> on ${formatTimestamp(Date.now())}</p>
